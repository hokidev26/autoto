(() => {
  ...
  const bootstrap = async () => {
    try {
      ...
      const { setUILocale } = await import("./modules/i18n.mjs?v=context-ring-3-dual-rail-collapse-1-background-upload-1-goal-command-2-first-run-setup-1-standalone-removed-2");
