...
const chatRenderingSplitURLs = [
  ...
  new URL("modules/chat-rendering-tools-glyphs.mjs", staticRoot),
  new URL("modules/chat-rendering-tools-cards.mjs", staticRoot),
  new URL("modules/chat-rendering-tools-reasoning.mjs", staticRoot),
