...
export const automationMessages = Object.freeze({
  "zh-CN": {
    automation: {
      ...
      buttons: { refreshAll: "刷新全部", refreshing: "刷新中…", history: "历史", loading: "加载中…", disable: "停用", enable: "启用", runNow: "立即运行", delete: "删除", returnSchedules: "返回排程", testConnection: "测试连接", retry: "重试", revoke: "撤销", approveLocal: "本地双确认批准", deny: "拒绝", createSchedule: "创建排程", creating: "创建中…", createTelegram: "创建 Telegram 连接", createHomeAssistant: "创建 Home Assistant 连接", createPairingCode: "生成配对码", requestLocal: "本地双确认并请求", newSchedule: "+ 新建排程", newTelegram: "+ 新建连接", newHomeAssistant: "+ 新建连接", newPairingCode: "+ 生成配对码", newDeviceAction: "+ 发起动作", closeForm: "收起表单" },
      pillars: { configured: "已配置", notConfigured: "尚未配置", manage: "管理", telegram: { title: "聊天渠道（Telegram）", description: "把会话接到 Telegram，配对后可在手机上收发消息。", cta: "连接 Telegram", summary: "{count} 个连接 · {paired} 个配对" }, schedules: { title: "排程任务", description: "用 Cron 定时执行受限权限的后台任务。", cta: "创建排程", summary: "{count} 个排程 · {enabled} 个已启用" }, home: { title: "家电（Home Assistant）", description: "连接 Home Assistant，只读查看实体并在本地审批动作。", cta: "连接 Home Assistant", summary: "{count} 个连接 · {devices} 个实体" } },
      pending: { title: "待审批的设备动作（{count}）", description: "这些请求正在等待本地双确认，逾期会自动失效。", jump: "查看全部" },
      confirm: {
      ...
      schedule: {
        kicker: "排程", title: "受限权限后台任务", description: "Cron 到点或手动立即运行；危险的 bypassPermissions 不在此提供。", empty: "暂无排程，先创建一个受限权限任务。", name: "名称", namePlaceholder: "每晚测试", preset: "常用 Preset", custom: "自定义 Cron", presetLabels: { "@every 15m": "每 15 分钟", "@every 30m": "每 30 分钟", "@hourly": "每小时", "@daily": "每天（00:00）", "@weekly": "每周（周日 00:00）", "0 9 * * 1": "每周一 09:00", "0 22 * * *": "每天 22:00" }, expression: "Cron 表达式", expressionPlaceholder: "@every 15m", preview: "下次运行（预估）：{timestamp}", previewUnknown: "无法在本地预览，创建后以服务端计算为准", agentId: "Agent ID", agentIdPlaceholder: "agent-id", selectAgent: "选择会话", lastRun: "上次运行", neverRan: "从未运行", timezone: "时区", timezonePlaceholder: "Asia/Shanghai", permission: "权限", environment: "环境", narrator: "叙述者", prompt: "任务内容", promptPlaceholder: "运行测试并汇总失败；不要修改文件。", nextRun: "下次运行", permissions: "权限", environments: "环境", narratorLabel: "叙述者", history: "运行历史", runMs: "{duration} ms", permissionModes: { readOnly: "只读（推荐）", acceptEdits: "允许修改文件" }, environmentModes: { workline: "关联项目工作区", standalone: "独立工作区" }, narratorModes: { reuse: "复用关联叙述者", new: "每次运行新建叙述者" }, unknownValue: "未知选项（{value}）"
      },
      ...
      pairing: { kicker: "配对", title: "一次性配对码", description: "未配对 chat 不应获得响应；撤销后立即失效。", connection: "Telegram 连接", selectConnection: "选择连接", agentId: "Agent ID", agentIdPlaceholder: "agent-id", selectAgent: "选择会话", code: "一次性配对码", expiresAt: "过期：{timestamp}", empty: "暂无已配对会话。", agentAt: "Agent {agentId} · {timestamp}" },
      homeAssistant: { kicker: "Home Assistant", title: "家电连接与只读实体", description: "实体列表只读展示；Access token 仅允许 env: 引用。", name: "名称", url: "Base URL", urlPlaceholder: "http://homeassistant.local:8123", credential: "Access token 环境变量引用", credentialPlaceholder: "env:AUTOTO_HOME_ASSISTANT_TOKEN", empty: "暂无 Home Assistant 连接。", viewConnection: "查看连接", selectConnection: "选择 Home Assistant 连接", search: "搜索实体", searchPlaceholder: "输入 entity id 或名称", requestAction: "发起动作", devicesLimit: "最多显示 {count} 个实体，DOM 有界。", noDevices: "该连接没有可读实体。", createConnectionFirst: "先创建 Home Assistant 连接。", readonly: "只读" },
  ...
  "zh-TW": {
    automation: {
      ...
      buttons: { refreshAll: "重新整理全部", refreshing: "重新整理中…", history: "歷史", loading: "載入中…", disable: "停用", enable: "啟用", runNow: "立即執行", delete: "刪除", returnSchedules: "返回排程", testConnection: "測試連線", retry: "重試", revoke: "撤銷", approveLocal: "本機雙重確認批准", deny: "拒絕", createSchedule: "建立排程", creating: "建立中…", createTelegram: "建立 Telegram 連線", createHomeAssistant: "建立 Home Assistant 連線", createPairingCode: "產生配對碼", requestLocal: "本機雙重確認並請求", newSchedule: "+ 新增排程", newTelegram: "+ 新增連線", newHomeAssistant: "+ 新增連線", newPairingCode: "+ 產生配對碼", newDeviceAction: "+ 發起動作", closeForm: "收合表單" },
      pillars: { configured: "已設定", notConfigured: "尚未設定", manage: "管理", telegram: { title: "聊天渠道（Telegram）", description: "把對話接上 Telegram，配對後可在手機上收發訊息。", cta: "連接 Telegram", summary: "{count} 個連線 · {paired} 個配對" }, schedules: { title: "排程任務", description: "用 Cron 定時執行受限權限的背景任務。", cta: "建立排程", summary: "{count} 個排程 · {enabled} 個已啟用" }, home: { title: "家電（Home Assistant）", description: "連接 Home Assistant，唯讀檢視實體並在本機審批動作。", cta: "連接 Home Assistant", summary: "{count} 個連線 · {devices} 個實體" } },
      pending: { title: "待審批的裝置動作（{count}）", description: "這些請求正在等待本機雙重確認，逾期會自動失效。", jump: "查看全部" },
      ...
      schedule: { kicker: "排程", title: "受限權限背景任務", description: "Cron 到點或手動立即執行；此處不提供危險的 bypassPermissions。", empty: "暫無排程，先建立一個受限權限任務。", name: "名稱", namePlaceholder: "每晚測試", preset: "常用 Preset", custom: "自訂 Cron", presetLabels: { "@every 15m": "每 15 分鐘", "@every 30m": "每 30 分鐘", "@hourly": "每小時", "@daily": "每天（00:00）", "@weekly": "每週（週日 00:00）", "0 9 * * 1": "每週一 09:00", "0 22 * * *": "每天 22:00" }, expression: "Cron 表達式", expressionPlaceholder: "@every 15m", preview: "下次執行（預估）：{timestamp}", previewUnknown: "無法在本機預覽，建立後以伺服器計算為準", agentId: "Agent ID", agentIdPlaceholder: "agent-id", selectAgent: "選擇對話", lastRun: "上次執行", neverRan: "從未執行", timezone: "時區", timezonePlaceholder: "Asia/Shanghai", permission: "權限", environment: "環境", narrator: "敘述者", prompt: "任務內容", promptPlaceholder: "執行測試並彙總失敗；不要修改檔案。", nextRun: "下次執行", permissions: "權限", environments: "環境", narratorLabel: "敘述者", history: "執行歷史", runMs: "{duration} ms", permissionModes: { readOnly: "唯讀（建議）", acceptEdits: "允許修改檔案" }, environmentModes: { workline: "關聯專案工作區", standalone: "獨立工作區" }, narratorModes: { reuse: "重用關聯敘述者", new: "每次執行新建敘述者" }, unknownValue: "未知選項（{value}）" },
      ...
      pairing: { kicker: "配對", title: "一次性配對碼", description: "未配對 chat 不應獲得回應；撤銷後立即失效。", connection: "Telegram 連線", selectConnection: "選擇連線", agentId: "Agent ID", agentIdPlaceholder: "agent-id", selectAgent: "選擇對話", code: "一次性配對碼", expiresAt: "過期：{timestamp}", empty: "暫無已配對工作階段。", agentAt: "Agent {agentId} · {timestamp}" },
      homeAssistant: { kicker: "Home Assistant", title: "家電連線與唯讀實體", description: "實體清單僅供唯讀展示；Access token 僅允許 env: 引用。", name: "名稱", url: "Base URL", urlPlaceholder: "http://homeassistant.local:8123", credential: "Access token 環境變數引用", credentialPlaceholder: "env:AUTOTO_HOME_ASSISTANT_TOKEN", empty: "暫無 Home Assistant 連線。", viewConnection: "查看連線", selectConnection: "選擇 Home Assistant 連線", search: "搜尋實體", searchPlaceholder: "輸入 entity id 或名稱", requestAction: "發起動作", devicesLimit: "最多顯示 {count} 個實體，DOM 有界。", noDevices: "此連線沒有可讀實體。", createConnectionFirst: "請先建立 Home Assistant 連線。", readonly: "唯讀" },
  ...
  en: {
    automation: {
      ...
      buttons: { refreshAll: "Refresh all", refreshing: "Refreshing…", history: "History", loading: "Loading…", disable: "Disable", enable: "Enable", runNow: "Run now", delete: "Delete", returnSchedules: "Back to schedules", testConnection: "Test connection", retry: "Retry", revoke: "Revoke", approveLocal: "Approve with local double confirmation", deny: "Deny", createSchedule: "Create schedule", creating: "Creating…", createTelegram: "Create Telegram connection", createHomeAssistant: "Create Home Assistant connection", createPairingCode: "Generate pairing code", requestLocal: "Double-confirm locally and request", newSchedule: "+ New schedule", newTelegram: "+ New connection", newHomeAssistant: "+ New connection", newPairingCode: "+ Generate pairing code", newDeviceAction: "+ Request action", closeForm: "Hide form" },
      pillars: { configured: "Configured", notConfigured: "Not set up", manage: "Manage", telegram: { title: "Chat channel (Telegram)", description: "Connect conversations to Telegram; once paired you can send and receive from your phone.", cta: "Connect Telegram", summary: "{count} connections · {paired} pairings" }, schedules: { title: "Scheduled tasks", description: "Run restricted background tasks on a Cron timer.", cta: "Create schedule", summary: "{count} schedules · {enabled} enabled" }, home: { title: "Home (Home Assistant)", description: "Connect Home Assistant to view entities read-only and approve actions locally.", cta: "Connect Home Assistant", summary: "{count} connections · {devices} entities" } },
      pending: { title: "Device actions awaiting approval ({count})", description: "These requests are waiting for local double confirmation and expire automatically.", jump: "View all" },
