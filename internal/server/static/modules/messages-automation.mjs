...
export const automationMessages = Object.freeze({
  "zh-CN": {
    automation: {
      ...
      schedule: {
        kicker: "排程", title: "受限权限后台任务", description: "Cron 到点或手动立即运行；危险的 bypassPermissions 不在此提供。", empty: "暂无排程，先创建一个受限权限任务。", name: "名称", namePlaceholder: "每晚测试", preset: "常用 Preset", custom: "自定义 Cron", presetLabels: { "@every 15m": "每 15 分钟", "@hourly": "每小时", "@daily": "每天" }, expression: "Cron 表达式", expressionPlaceholder: "@every 15m", agentId: "Agent ID", agentIdPlaceholder: "agent-id", timezone: "时区", timezonePlaceholder: "Asia/Shanghai", permission: "权限", environment: "环境", narrator: "叙述者", prompt: "任务内容", promptPlaceholder: "运行测试并汇总失败；不要修改文件。", nextRun: "下次运行", permissions: "权限", environments: "环境", narratorLabel: "叙述者", history: "运行历史", runMs: "{duration} ms", permissionModes: { readOnly: "只读（推荐）", acceptEdits: "允许修改文件" }, environmentModes: { workline: "关联项目工作区", standalone: "独立工作区" }, narratorModes: { reuse: "复用关联叙述者", new: "每次运行新建叙述者" }, unknownValue: "未知选项（{value}）"
      },
  ...
  "zh-TW": {
    automation: {
      ...
      schedule: { kicker: "排程", title: "受限權限背景任務", description: "Cron 到點或手動立即執行；此處不提供危險的 bypassPermissions。", empty: "暫無排程，先建立一個受限權限任務。", name: "名稱", namePlaceholder: "每晚測試", preset: "常用 Preset", custom: "自訂 Cron", presetLabels: { "@every 15m": "每 15 分鐘", "@hourly": "每小時", "@daily": "每天" }, expression: "Cron 表達式", expressionPlaceholder: "@every 15m", agentId: "Agent ID", agentIdPlaceholder: "agent-id", timezone: "時區", timezonePlaceholder: "Asia/Shanghai", permission: "權限", environment: "環境", narrator: "敘述者", prompt: "任務內容", promptPlaceholder: "執行測試並彙總失敗；不要修改檔案。", nextRun: "下次執行", permissions: "權限", environments: "環境", narratorLabel: "敘述者", history: "執行歷史", runMs: "{duration} ms", permissionModes: { readOnly: "唯讀（建議）", acceptEdits: "允許修改檔案" }, environmentModes: { workline: "關聯專案工作區", standalone: "獨立工作區" }, narratorModes: { reuse: "重用關聯敘述者", new: "每次執行新建敘述者" }, unknownValue: "未知選項（{value}）" },
  ...
  en: {
    automation: {
      ...
      schedule: { kicker: "Schedules", title: "Restricted background tasks", description: "Run on Cron or manually; dangerous bypassPermissions is not available here.", empty: "No schedules yet. Create a restricted task first.", name: "Name", namePlaceholder: "Nightly tests", preset: "Preset", custom: "Custom Cron", presetLabels: { "@every 15m": "Every 15 minutes", "@hourly": "Hourly", "@daily": "Daily" }, expression: "Cron expression", expressionPlaceholder: "@every 15m", agentId: "Agent ID", agentIdPlaceholder: "agent-id", timezone: "Time zone", timezonePlaceholder: "America/Los_Angeles", permission: "Permission", environment: "Environment", narrator: "Narrator", prompt: "Task content", promptPlaceholder: "Run tests and summarize failures; do not modify files.", nextRun: "Next run", permissions: "Permission", environments: "Environment", narratorLabel: "Narrator", history: "Run history", runMs: "{duration} ms", permissionModes: { readOnly: "Read only (recommended)", acceptEdits: "Allow file edits" }, environmentModes: { workline: "Linked project workspace", standalone: "Standalone workspace" }, narratorModes: { reuse: "Reuse linked narrator", new: "Create a narrator for each run" }, unknownValue: "Unknown option ({value})" },
