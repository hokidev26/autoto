...
export function createConversationTitleHelpers({
  ...
  // setHTMLIfChanged rather than a plain write: a switch calls this several
  // times -- from enterAgent, from renderModelOptions, and again from the live
  // snapshot -- with identical content each time. See dom.mjs.
